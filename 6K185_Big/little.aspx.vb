...
Partial Class little
    ...
    Protected Sub CreateUserWizard1_ActiveStepChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CreateUserWizard1.ActiveStepChanged
        ...
        If CreateUserWizard1.ActiveStep.Title = "Complete" Then
            ...
            Dim updatesql As String = "INSERT INTO [Big_little] ([UserID], [LittleFN], [littleLN], [city], [streetAddress],[state],[postcode],[phone],[emailaddress],[availabletime],[faractivities],[personality],[schoolsubject],[sport]) VALUES (@userId, @FirstName, @lastName, @City,@streetaddress,@state,@postcode,@phone,@email,@availabletime,@faractivities,@personality,@schoolsubject,@sport)"
