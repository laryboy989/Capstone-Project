...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:TextBox ID="tb_searchvolunteer" AutoPostBack="true" Placeholder="Search by Last Name, First Name, or Available Time" runat="server" Width="500px"></asp:TextBox>
               
                 <span class="input-group-btn">
                 <asp:Button ID="btsearchvolunteer" runat="server" Text="Search" />
                 </span>
